...
public class ConsultaBeanConfiguration {
    ...
    @Bean
    IHorarioDisponivelService horarioDisponivelService(IHorarioDisponivelRepository horarioDisponivelRepository, IMedicoRepository medicoRepository) {
        return new HorarioDisponivelService(horarioDisponivelRepository, medicoRepository);
    }
}
